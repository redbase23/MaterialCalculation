...
/*
подсчет материалов на шов расширения с мастикой
 */
...
public class ExpansionJointActivity extends AppCompatActivity {
    //материалы
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.expansion_joint_activity);

        lenghtET=findViewById(R.id.lenghtET2);
        widthJointExp=findViewById(R.id.widthJointExp2);
        joinCutDeph = findViewById(R.id.expJointDepth2);
        depthSealKameraET=findViewById(R.id.depthSealKameraET2);
        depthSealKameraET.setVisibility(View.GONE);
        btnResult=findViewById(R.id.calculateMaterialsButton2);
        btnResult.setEnabled(false);
        btnSendVia=findViewById(R.id.sendvia2);
        btnSendVia.setVisibility(View.INVISIBLE);
        btnAddToTotal=findViewById(R.id.addToTotal_Button2);
        btnAddToTotal.setVisibility(View.INVISIBLE);
        SealantHotRB=findViewById(R.id.SealantHotRB2);
        ProofmateRB=findViewById(R.id.ProofmateRB2);
        HowToSealChoiseRG=findViewById(R.id.HowToSealChoiseRG2);
        rodCheckBox = findViewById(R.id.rodsCheckBox2);
        rodCheckBox.setVisibility(View.GONE);
        landsCheckBox=findViewById(R.id.landsCheckBox2);
        depthSealKameraTV=findViewById(R.id.depthSealKameraTV2);
        depthSealKameraTV.setVisibility(View.GONE);
        rodsChooseTV=findViewById(R.id.rodsChooseTV2);
        rodsChooseTV.setVisibility(View.GONE);
        dividerDepthSeal =findViewById(R.id.divider5_2);
        dividerDepthSeal.setVisibility(View.GONE);
        dividerRods=findViewById(R.id.divider8_2);
        dividerRods.setVisibility(View.GONE);
        rod = findViewById(R.id.RodChooseSpinner2);
        sealant = findViewById(R.id.sealantHotChoose2);
        proofmate =findViewById(R.id.ProofmateChoose2);
        penolonSpinner= findViewById(R.id.PenolonChooseSpinner2);
        resultMaterials = findViewById(R.id.resultMaterials2);
    ...
    public  void calculateMaterials (View view){
        ...
        //подготовка данных для отправки в итоговый лист
        itemToSend = "Шов расширения в покрытии: "+ilLenght+"п.м.";
